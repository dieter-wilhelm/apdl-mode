...
~ansys-mode-162-1.emacs-24.5-bin-i686-mingw32.zip~ with binaries of
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; "c:\\emacs-24.5\\share\\emacs\\24.5\\site-lisp\\ansys-mode-162-1"
  ;; Linux directory example:
  ;; "/usr/local/src/emacs/emacs-24.5/site-lisp/ansys-mode-162-1"
...
(currently "2") of ANSYS-Mode, thus "162-1" for this particular
...
** Files
  ...
  *Auxiliaries and Documentation*:
  ...
  # - helper/tools/bin/ansys-mode-162-1.sh -- A wrapper for calling Emacs
