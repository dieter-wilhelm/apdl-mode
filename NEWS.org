...
** Version 20.2.0
   ...
   - Updated docu and completions for keywords, elements, etc. to v193
     (mostly to v201)
   - A-M can now browse the ANSYS online-help (you don't have to
     install the local ANSYS help package, but it is recommended
     because of speed reasons ;-)
** Version 20.1.1 2020-02 bugfix
