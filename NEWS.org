...
** Version 16.1.2, not yet released, targeted for August 2015
   - Realised sending code to the ANYSClassics GUI as well currently
     only for GNU-Linux/Unix.
   ...
   - Reorganised and simplified the installation and configuration.
     Made the initialisation more intelligent.
   ...
   - New functions: Reading the ANSYS-Mode documentation in a Browser,
