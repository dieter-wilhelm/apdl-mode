...
** Version 20.4.0: 2020-04, update to Ansys 2020R1
   ...
   - The apdl-mode function is now called when opening files with the
     suffixes ".mac", ".dat" and ".inp". without further user
     configuration.
   - Added a menu entry for displaying the user's licenses
