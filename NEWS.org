...
** Version 16.1.2, not yet released, targeted for August Realised
   - 2015 sending code to the ANYSClassics GUI as well (currently
     only on GNU-Linux/Unix).
   ...
   - Reorganised and simplified the installation and configuration.
     Made the initialisation more automatic.
