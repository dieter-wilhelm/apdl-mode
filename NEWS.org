...
** Version R20.1 2020-02
   - Changed version name scheme
   - Installation from Melpa
   - Changed the name to APDL-Mode
   - Added key-bindings to the license buffer *ANSYS-licenses*
     o - occur search
     g - refresh license status
     q - burry the license buffer
     Q - quit license buffer

** Version 162-1, not yet released, targeted for September
