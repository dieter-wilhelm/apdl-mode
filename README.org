...
[[https://github.com/dieter-wilhelm/ansys-mode/releases][Github releases site]] or at [[https://drive.google.com/drive/folders/0Bxnk08BGWfexUThqbWxLX1NyeTg][Google's ANSYS-Mode drive]].  There are
...
Emacs together with ANSYS-Mode and 3) the sources of ANSYS-Mode alone.
You might fetch these archives via command line way, e. g. for the
version of ANSYS-Mode bundled with Emacs binaries for Windows:
#+BEGIN_SRC sh
...
editor you will find tutorials in the download section.  For an
