...
[[https://github.com/dieter-wilhelm/ansys-mode/releases][Github releases site]] or at [[https://drive.google.com/drive/folders/0Bxnk08BGWfexUThqbWxLX1NyeTg][Google's ANSYS-Mode drive]].

Or via command line way, e. g. for the windows version bundled with
Emacs:
#+BEGIN_SRC sh
...
Emacs you will find in the download section tutorials.  For an
immediate access have a look at the
