...
- keyword.el: Highlighting variables built from
  helper/fontification.el
- template.el: Template definitions
- process.el: Variables and functions related to solver
  processes
...
- doc/A-M_in-depth_tutorial.ansys -- Hands-on tutorial's supplementary APDL code
...
in `template.el' and can be used similarly or complementary to
