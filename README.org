...
** Pin-pointing the relevant ANSYS documentation
   ...
   and other manual topics.  (Since ANSYS V19 the online help is the
   default.  To speed up the access I reccomend installing the local
   ANSYS documentation.)  The topics are shown in a web browser.
