...
GNU-Linux64.  It was also tested with Emacs-23.1 (realeased July 2009)
...
- ansys-keyword.el: Fontification variables built from
...
optionally, if you have adminstrator rights you can install Emacs in
your system.
   #+BEGIN_SRC sh
   make install
   #+END_SRC
