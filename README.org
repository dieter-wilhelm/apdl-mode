...
* Configuration and Customisation
  ...
  file endings, especially the `.mac' suffix.  Please read the file
  [[file:apdl-config.org][apdl-config.org]], or the accompanying template file [[file:ansys-config.el][apdl-config.el]].
