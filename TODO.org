...
Focus on WorkBench Command Snippets!

1) Help system, online
2) Docu, intro
3) WB Templates
4) Base A-M on ANSYS v201
5) Clean menus, esp. templates
...
** Todos
   ...
   - What about hint to WB JavaScript!?
** minor bugs
...
** checks
   - First edit in *APDL code*: self-insert-command: Wrong number of
      arguments: (0 . 0), 3?
   - Customisation system, is it working?
** wishes
   - Melpa integration for later
   - document the Apdl Parameter Help Duration in M-?
   - how about deleting the work branch, v20, v16?
   - are the material properties documented, matlib?  Matlib is used
     in -template.el, how about document the material db somewhere?
* 20.1.0
** misc
