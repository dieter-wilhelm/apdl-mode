...
** Wish-list
   ...
   - a-start-wb: start-process seemingly uses the current working
     directory, there might be a problem, when "pwd" of the curretn
     buffer was/is a network drive which might temporarily not
     available.
