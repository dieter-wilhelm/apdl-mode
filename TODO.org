...
** Todos, bugs, checks
   ...
   - M-C-i is not consistent with M-?! The mix of Ansys v195 and docu
     v201 version..
** minor bugs
   - C-u C-c C-b in browser on Win10 for some of the "All"stuff isn't
     working for chrome?
...
*** misc
    ...
    3) Start optionally runbWB2 --aim, Discovery AIM
    4) Ansys is often used synonymous for Ansys MAPDL solver /
