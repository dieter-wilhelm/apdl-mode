...
r  - Navigation ::  C-c { does not skip an overlay in a number-block
...
** Release June
   - complete the template choise section in the menu
...
** Freeze proceedures
  ...
  # ;  (tags-query-replace "GNU/Linux" "GNU-Linux") ;-)
    ...
    24.5 -Q testing: fontification.mac /*commands and default command
