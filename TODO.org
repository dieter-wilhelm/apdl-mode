...
* Version 20.5.0, info docu?

* TODO Version 20.4.0, completion and help updated to 2020R1
  DEADLINE: <2020-04-27 Mo>
** Todos, bugs
   - user-error: Info file top does not exist
   - Update -config.org with new defcustoms
   - Update and centralise DOCUs, info style?
*** COMMENT State of documentation
