...
* 16.1.2:
** Bugs
   -   Mouse completion is working with middle mouse button but only
...
** Wish-list
   ...
   - rework default.el to a default.org and add to gh-pages
   ...
   - GH-pages: images in README.org not working
