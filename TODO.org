...
* R20.1.0
  ...
  - Emacs 25.1 September 2016, how to We need emacs >= 24 ;-) lexical
    and other stuff
  ANSYS is often used for ANSYS MAPDL solver / interpreter or ANSYS Classics GUI
  - apdl-start-ansys-help
  - apdl-anys-directory
  - -install-dir
  - apdl-license-file
  - apdl-license => apdl-ansys-license?
  - apdl-kill-ansys
  - wikipedia APDL, Ansys
* 170-1:
* 162-2:
** Bugs
