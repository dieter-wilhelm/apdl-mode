...
* TODO 20.2.0 Release
  ...
  Feature freeze [2020-02-27 Do]
  Testing of the template branch
  Update documentation, html brutally outdated, ..
  - gh-pages:
    - create a README.org (copy from index.org?)
    - makefile for htmls or is it org-mode publish

** Todos, bugs
   - M-? with too many commas throws an error, then the counting is
     not updated any longer!
   - -wbt-if: strange behaviour
...
*** misc
   - include example code in function APDL
   - open EWW in another window!
   - Melpa integration <= 2021?
   ...
   - Start runbWB2 --aim, Discovery AIM
