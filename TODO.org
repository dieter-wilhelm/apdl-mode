...
* R20.1.0
  ...
  # - apdl-license-categories OK
  # - apdl-ansys-help-path OK
  # - apdl-ansys-help-program OK
  # - apdl-current-ansys-version OK
  # - apdl-ansys-program OK
  # - apdl-ansys-launcher OK
  # - apdl-ansys-wb OK
  # - apdl-kill-ansys OK
  # - apdl-start-ansys-help OK
  ...
  - M-x in docu strings => checkdoc

  - Check customisation system

  - check highlighting of license

  - Emacs 25.1 September 2016, how to: We need emacs >= 24 ;-) lexical
    and other stuff
...
------
  ...
  - Added keys to the *Licenses* buffer (formerly *ANSYS-license*)
    - Q -- close (kill-this-buffer)
    - q -- hide buffer (bury-buffer)
    - g -- update license status (apdl-license-status)
    - o -- apdl-occur

  - Renamed ANSYS-Mode to APDL-Mode
