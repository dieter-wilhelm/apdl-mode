...
*** misc
   ...
   - include example code in function apdl: no!
   ...
   - Start optionally runbWB2 --aim, Discovery AIM
* TODO 20.2.0 Release
  Feature freeze [2020-02-27 Do]: Testing of the template branch
...
* DONE 20.1.1 Release
  - updating intro tutorial and docu => presentation, (online)
    documentation: Is a mess, still ANSYS-Mode 16.1.!
** Bug
