...
/a-m.el/, which can be used as the configuration file for
...
#+END_SRC
in your configuration file or remove or rename /a-m.el/ (or at
...
hints in /a-m.el/ are indicated with DOUBLE semi-colons ~;;~,
