...
** Select and insert from the menu templates into your code \\ Screenshot with the ANSYS Classics GUI (left) and Emacs (right) on Win64 
...
** Check auto-insertion and outline your code (tree view)
  Create an APDL file with the suffix `.mac' and let Emacs auto-insert
