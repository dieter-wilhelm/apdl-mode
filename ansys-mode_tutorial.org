...
** Outline your code (similar to WorkBench tree view)
...
* Summary
** Summary: Levels of ANSYS-Mode usage
*** APDL viewer
         :PROPERTIES:
         :BEAMER_env: block
         :BEAMER_envargs: C[t]
#         :BEAMER_col: 0.5
         :END:
Navigating, viewing (highlighted code), inspecting APDL with the
    inbuilt 'online' help
*** APDL editor
         :PROPERTIES:
         :BEAMER_env: block
...
#         :BEAMER_col: 0.5
         :END:
    Convenience features: shortcut keybindings, outlining, code
    templates, completions, indentation, Emacs' facilities, ...
*** APDL process environment
         :PROPERTIES:
         :BEAMER_env: block
         :BEAMER_envargs: C[t]
#         :BEAMER_col: 0.5
         :END:
    Hybrid between coding and debugging (solver communication, UNIX
    only), license status, error file viewing, writing an abort file,
    ...
