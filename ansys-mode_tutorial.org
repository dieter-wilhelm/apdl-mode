...
######################################################################
# TODO
# - graphics for completions is missing
# - variable_buffer.png does not highlight the implicit variables
...
** Completion of around 2000 ANSYS symbols
  Move the cursor behind a character or word fragment and type *ESC
  TAB* (or *M-TAB* depending on the window manger setup) for getting
  all command-, element- and function names.
...
** Configure ANSYS-Mode
    ...
    ANSYS 14.0 for 64 bit.  If a functionality is missing please adjust either:
