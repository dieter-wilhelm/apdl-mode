...
#+BEAMER_HEADER_EXTRA: \titlegraphic{\includegraphics[width=10cm]{./ansys+emacs.png}}
...
** GNU Emacs editor support for working with ANSYS FEA
   ...
   Element Analysis) suite [[http://www.ansys.com][ANSYS]] (registered TM, ANalysis SYStem).
#+LaTeX: \\[.2cm]
...
#+LaTeX: \\[.2cm]
   [[http://www.gnu.org/home.en.html][GNU]] Emacs (Gnu's Not Unix) is an up-to-date, powerful, yet free
