a#+TITLE:     Guided ANSYS-Mode hands-on Tutorial
######################################################################
# TODO
...
*** Please read the *introductory* ANSYS-Mode tutorial first
    This is the file `A-M_introductory_tutorial-15.0.1.pdf' in the
...
#+begin_src ansys :tangle no
  !! Open `A-M_in-depth_tutorial-15.0.1.ansys' with "C-x C-f"!  You can take this
