...
#+TITLE: Guided APDL-Mode hands-on Tutorial
...
# #+DATE:      2012-06-17 Sa
#+DESCRIPTION: Guided APDL-Mode hands-on APDL Tutorial, Version 20.7.0
...
*** Please read the *introductory* APDL-Mode tutorial first
    ...
    mode's archive or use its [[https://dieter-wilhelm.github.io/ansys-mode/doc/A-M_in-depth_tutorial.html][online]] version.
...
#+begin_src ansys :exports none
  !! This is the auto-generated APDL source of the APDL-Mode
...
#+begin_src ansys :exports none
  !@ --- APDL-Mode defined abbreviations ---
#+end_src
...
#+begin_src ansys :exports none
   ...
   !@ ==============================
   !! Prerequisites:
   !! 1) A fully configured APDL-Mode and
...
**  Acknowledgements
    - Carsten Dominik :: Ingenious [[https://orgmode.org/][Org-mode]] for Emacs
