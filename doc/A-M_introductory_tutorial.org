...
***  Remarkably there are *no* costs and license restrictions also for commercial use
  ...
  the [[https://drive.google.com/folderview?id%3D0Bxnk08BGWfexUThqbWxLX1NyeTg&usp%3Dsharing#list][ANSYS-Mode download page]] on Google Drive.
# #+ATTR_HTML: width="1200"
#+BEGIN_LaTeX
\href{https://drive.google.com/folderview?id=0Bxnk08BGWfexUThqbWxLX1NyeTg&usp=sharing}{%
  \includegraphics[width=12cm]{./google_drive.png}%
}
#+END_LaTeX 
#+HTML: <img src="./download.png" alt="download page from Google Drive">
