...
* Configuration and Customisation
  ...
  Please read [[file:apdl-config.org][apdl-config.org]], or the accompanying configuration
...
* Further Resources
  ...
  GNU-Emacs and other APDL editors please read the [[file:resources.org][RESOURCES]] file.
...
* GNU GPL v3 License
  ...
  yourself with the [[file:LICENSE][LICENSE]] file.
* Acknowledgements
