...
* TODO Version 20.5.0
  DEADLINE: <2020-05-01 Fr>
  help for get- and fortran functions
** Todos, bugs
   - C-c C-b is able to provide help for functions but only on such a
     symbol yet
   - improve docu, especially -> M-? nor C-c C-b with (get)
