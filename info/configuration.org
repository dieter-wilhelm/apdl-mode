...
specific documentation of individual variables.  Let’s change for
...
configuration file in your home directory) for future sessions as
well.
...
necessary to reload APDL-Mode.  You can do this with the interactive
command ‘apdl-reload-apdl-mode’ or with the respective, toplevel APDL
menu entry.
