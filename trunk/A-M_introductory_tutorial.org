...
#+LaTeX: \\[.2cm]
   ...
   The mode offers also managing and communication
...
** Explore the ANSYS-Mode menu
  ...
  /C:Program Files/ under Win64, otherwise, for system dependent
  stuff, like browsing the APDL help with *C-c C-b* you can easily
  reconfigure. (All described features can be executed through the
