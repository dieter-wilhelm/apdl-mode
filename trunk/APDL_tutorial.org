...
#+begin_src ansys
  ...
  !! It is highlighted as well, but it is further completable.
#+end_src ansys
*** Dynamic completion
...
#+end_src
Inspect available abbreviation definitions from ANSYS-Mode.
#+begin_src ansys
...
** Use the Emacs integrated RPN Calculator
   ...
   arguably superior input convention.
...
var2 = tan(nx(.3*5))  ! this is valid code
!!
#+end_src
#+begin_src  ansys
