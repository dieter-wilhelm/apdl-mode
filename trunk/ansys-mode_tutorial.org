...
*** Installation:
    Detailed installation instructions especially for Unix and Win32
    systems: Please have a look in the accompanying /README/ file.
...
*** Licensing:
    ...
    commerically.  Both are under the [[http://www.gnu.org/copyleft/gpl.html][GNU puplic license]], if you are
    interested see also the /LICENSE/ file.
